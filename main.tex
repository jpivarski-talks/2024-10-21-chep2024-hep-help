...
\xdefinecolor{lightblue}{rgb}{0.75,0.75,1}
...
\begin{frame}{One more, not here at CHEP: ``chATLAS''}
\vspace{0.2 cm}
\begin{center}
\only<1>{\fbox{\includegraphics[width=0.94\linewidth]{PLOTS/chATLAS-40-percent-page18.pdf}}}\only<2>{\fbox{\includegraphics[width=0.94\linewidth]{PLOTS/chATLAS-40-percent-page18-2.pdf}}}\only<3>{\fbox{\includegraphics[width=0.94\linewidth]{PLOTS/chATLAS-40-percent-page18-3.pdf}}}
\end{center}
\end{frame}
...
\vspace{0.35 cm}
\uncover<2->{The response can take up to a minute (much faster than a human responder).}

\vspace{0.35 cm}
\uncover<3->{\textcolor{darkblue}{Discussions or Issues?} Discussions are threaded (3 levels) with up/down votes,}
...
\item Gather documents from many sources: GitHub/GitLab, Slack, (public?) Mattermost, Gitter, StackOverflow, Discord, documentation websites, HSF-Training tutorial materials\ldots
\end{itemize}}}
...
\only<1>{\includegraphics[width=\linewidth]{PLOTS/explain-rag-1.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/explain-rag-2.pdf}}\only<3>{\includegraphics[width=\linewidth]{PLOTS/explain-rag-3.pdf}}\only<4>{\includegraphics[width=\linewidth]{PLOTS/explain-rag-4.pdf}}\only<5>{\includegraphics[width=\linewidth]{PLOTS/explain-rag-5.pdf}}
\end{columns}
...
\fbox{\includegraphics[width=\linewidth]{PLOTS/stackoverflow-screenshot.png}}

\column{0.25\linewidth}
\begin{minipage}{1.1\linewidth}
\raggedright \uncover<2->{Eliminating out-of-date answers, we have 85 question-answer pairs.}

\vspace{1 cm}
\raggedright \uncover<3->{(Almost all the answers were written by me.)}
\end{minipage}
\end{columns}
\end{frame}
...
\vspace{0.25 cm}
\uncover<2->{But whereas untuned ChatGPT always attempts non-vectorized answers to user questions, fine-tuned always attempts vectorized (though usually wrong) ones.}
...
\begin{uncoverenv}<4->
\normalsize
Fine-tuned ChatGPT: {\scriptsize (\mintinline{python}{ak.with_item} does not exist)}
...
\vspace{0.35 cm}
\begin{center}
\uncover<2->{\includegraphics[width=0.5\linewidth]{PLOTS/human-vs-untuned-vs-finetuned.pdf}}
\end{center}

\vspace{0.25 cm}
\uncover<3->{It takes 5--10 minutes to ``grade'' an answer; this can't be done in bulk.}
\end{frame}

\begin{frame}{What about using the LLM as a question-generator?}
\large
\vspace{0.25 cm}
\begin{center}
\hspace{2.5 cm}\includegraphics[width=0.8\linewidth]{PLOTS/explain-rag-4.pdf}
\end{center}

\vspace{-0.35 cm}
\begin{columns}
\column{0.5\linewidth}
\uncover<2->{\includegraphics[width=\linewidth]{PLOTS/generated-questions-are-a-better-match-than-real-answers.pdf}}

\column{0.5\linewidth}

\uncover<2->{The similarity of a human query and an LLM-generated question is slightly better than a human query and the human source documents (classic RAG).}

\vspace{0.5 cm}
\uncover<3->{(Is it enough to matter?)}
\end{columns}
\end{frame}
